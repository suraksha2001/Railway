...
class Main{
    ...
    static String[] r = {"Mysore","Banglore","Coorg","Mandya","Nanjangud","Chamrajnagara","Madkeri"};
    ...
    public static void uS() {
        ...
        if(repass.equals(pass)){
            ...
            System.out.println("New Account is created sucessfully\n");
        }
        else{
    ...
    public static void trueUser() {
        ...
        System.out.println("3. View MyTickets");
